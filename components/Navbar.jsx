        ...
        <div className="relative flex h-20 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            ...
            <div className="hidden md:ml-6 md:block">
              <div className="flex space-x-2">
                <Link
                  href="/"
                  className={`${path==='/' ? 'underline underline-offset-8':''} text-white  px-3 py-2 hover:underline hover:underline-offset-8`}
                >
                  Home
                </Link>
                <Link
                  href="/properties"
                  className={`${path==='/properties' ? 'underline underline-offset-8':''} text-white  px-3 py-2  hover:underline hover:underline-offset-8`}
                >
                  Properties
                </Link>
                <Link
                  href="/properties/add"
                  className={`${path==='/properties/add' ? 'underline underline-offset-8':''} text-white  px-3 py-2  hover:underline hover:underline-offset-8`}
                >
                  Add Property
                </Link>
              </div>
          ...
          <div className="hidden md:block md:ml-6">
            <div className="flex items-center">
              <button
                className="flex items-center text-white  backdrop-filter bg-clip-padding bg-gray-400
        ...
        <div id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            ...
            <button
              className="flex items-center text-white  backdrop-filter bg-clip-padding bg-gray-400
              backdrop-blur-sm bg-opacity-10 border border-gray-100
           hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 my-4"
            >
              <FaGoogle className="mr-2" />
              <span>Login or Register</span>
            </button>
